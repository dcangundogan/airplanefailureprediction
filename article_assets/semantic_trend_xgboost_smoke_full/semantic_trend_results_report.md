...
- Random seed: 42
- Runtime: 9.7 minutes
- Command: `semantic_trend_xgboost_article_ready.py --datasets FD001 --methods numeric semantic hybrid --n-estimators 80 --out-dir article_assets\semantic_trend_xgboost_smoke_full`
